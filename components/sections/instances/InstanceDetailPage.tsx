          ...
          <div className="lg:col-span-2 space-y-6">
            <Card title="Instance State & Details" icon={<Settings className="text-slate-300" />}>
              <dl>
                ...
                <DetailItem label="Status" value={instance.status} icon={<ListChecks />} className={getStatusColor(instance.powerState, instance.status, instance.vm_state)} />
                <DetailItem label="VM State" value={instance.vm_state} icon={<ListChecks />} className={getStatusColor(instance.powerState, instance.status, instance.vm_state)} />
                <DetailItem label="Power State" value={instance.powerState} icon={<PowerIcon />} className={getStatusColor(instance.powerState, instance.status, instance.vm_state)} />
